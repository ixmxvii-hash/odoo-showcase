...
export const metadata: Metadata = {
  ...
  description: "Streamline food and beverage operations with Odoo ERP. Complete traceability, lot tracking, and production management for food manufacturers.",
  keywords: [
...
export default function FoodBeveragePage() {
  const industry = industries.foodBeverage;
      ...
      <section className="pt-32 pb-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-emerald-600 to-green-700 bg-clip-text text-transparent">
          ...
          {/* Solutions Preview */}
          <div className="bg-gradient-to-br from-emerald-50 to-white rounded-2xl p-8 mb-16">
          ...
          {/* City Selection CTA */}
          <div className="bg-gradient-to-br from-emerald-600 to-green-700 rounded-2xl p-12 text-white text-center">
            <MapPin className="w-16 h-16 mx-auto mb-6 opacity-90" />
            <h2 className="text-3xl font-bold mb-4">Select Your Location</h2>
            <p className="text-emerald-100 mb-8 max-w-2xl mx-auto">
              Get city-specific insights, local case studies, and connect with food & beverage businesses in your area.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-4 max-w-4xl mx-auto">
              {cities.map((city) => (
                ...
                >
                  ...
                  <div className="text-sm text-emerald-100 mb-4">{city.region}</div>
          ...
          {/* Key Modules Preview */}
          <div className="mt-16">
            <h2 className="text-3xl font-bold mb-8 text-center">Key Odoo Modules for Food & Beverage</h2>
