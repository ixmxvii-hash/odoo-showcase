...
export const metadata: Metadata = {
  ...
  description: "Streamline distribution and wholesale operations with Odoo ERP. Complete inventory management, order processing, and logistics tracking.",
  keywords: [
    "Distribution ERP",
...
export default function DistributionPage() {
  const industry = industries.distribution;
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-purple-600 to-purple-800 bg-clip-text text-transparent">
              Distribution & Wholesale ERP Solutions
            </h1>
          ...
          {/* Solutions Preview */}
          <div className="bg-gradient-to-br from-purple-50 to-white rounded-2xl p-8 mb-16">
          ...
          {/* City Selection CTA */}
          <div className="bg-gradient-to-br from-purple-600 to-purple-800 rounded-2xl p-12 text-white text-center">
            <MapPin className="w-16 h-16 mx-auto mb-6 opacity-90" />
            <h2 className="text-3xl font-bold mb-4">Select Your Location</h2>
            <p className="text-purple-100 mb-8 max-w-2xl mx-auto">
              Get city-specific insights, local case studies, and connect with distribution businesses in your area.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-4 max-w-4xl mx-auto">
              {cities.map((city) => (
                ...
                >
                  ...
                  <div className="text-sm text-purple-100 mb-4">{city.region}</div>
          ...
          {/* Key Modules Preview */}
          <div className="mt-16">
            <h2 className="text-3xl font-bold mb-8 text-center">Key Odoo Modules for Distribution</h2>
