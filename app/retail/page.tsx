...
export const metadata: Metadata = {
  ...
  description: "Streamline retail and e-commerce operations with Odoo ERP. Complete POS, inventory management, and online store integration.",
  keywords: [
    "Retail ERP",
    "E-commerce Software",
      ...
      <section className="pt-32 pb-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-rose-600 to-pink-700 bg-clip-text text-transparent">
              Retail & E-commerce ERP Solutions
            </h1>
          ...
          {/* Solutions Preview */}
          <div className="bg-gradient-to-br from-rose-50 to-white rounded-2xl p-8 mb-16">
          ...
          {/* City Selection CTA */}
          <div className="bg-gradient-to-br from-rose-600 to-pink-700 rounded-2xl p-12 text-white text-center">
            ...
            <p className="text-rose-100 mb-8 max-w-2xl mx-auto">
              Get city-specific insights, local case studies, and connect with retail businesses in your area.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-4 max-w-4xl mx-auto">
              {cities.map((city) => (
                ...
                >
                  ...
                  <div className="text-sm text-rose-100 mb-4">{city.region}</div>
          ...
          {/* Key Modules Preview */}
          <div className="mt-16">
            <h2 className="text-3xl font-bold mb-8 text-center">Key Odoo Modules for Retail</h2>
