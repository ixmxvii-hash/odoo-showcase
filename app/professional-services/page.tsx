...
export const metadata: Metadata = {
  ...
  description: "Streamline professional services operations with Odoo ERP. Complete project management, time tracking, and billing for service firms.",
  keywords: [
...
export default function ProfessionalServicesPage() {
  const industry = industries.professionalServices;
      ...
      <section className="pt-32 pb-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-cyan-600 to-blue-700 bg-clip-text text-transparent">
              Professional Services ERP Solutions
            </h1>
          ...
          {/* Solutions Preview */}
          <div className="bg-gradient-to-br from-cyan-50 to-white rounded-2xl p-8 mb-16">
          ...
          {/* City Selection CTA */}
          <div className="bg-gradient-to-br from-cyan-600 to-blue-700 rounded-2xl p-12 text-white text-center">
            <MapPin className="w-16 h-16 mx-auto mb-6 opacity-90" />
            <h2 className="text-3xl font-bold mb-4">Select Your Location</h2>
            <p className="text-cyan-100 mb-8 max-w-2xl mx-auto">
              Get city-specific insights, local case studies, and connect with professional services firms in your area.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-4 max-w-4xl mx-auto">
              {cities.map((city) => (
                <Link
                  key={city.slug}
                  href={`/${city.slug}/professional-services`}
                ...
                >
                  ...
                  <div className="text-sm text-cyan-100 mb-4">{city.region}</div>
          ...
          {/* Key Modules Preview */}
          <div className="mt-16">
            <h2 className="text-3xl font-bold mb-8 text-center">Key Odoo Modules for Professional Services</h2>
