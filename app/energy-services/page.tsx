...
export const metadata: Metadata = {
  ...
  description: "Streamline oilfield and equipment services operations with Odoo ERP. Complete project management, equipment tracking, and field service management.",
  keywords: [
    "Energy Services ERP",
    "Oilfield Software",
...
export default function EnergyServicesPage() {
  const industry = industries.energyServices;
    ...
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="pt-32 pb-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Solutions Preview */}
          <div className="bg-gradient-to-br from-amber-50 to-white rounded-2xl p-8 mb-16">
          ...
          {/* City Selection CTA */}
          <div className="bg-gradient-to-br from-amber-600 to-orange-700 rounded-2xl p-12 text-white text-center">
            <MapPin className="w-16 h-16 mx-auto mb-6 opacity-90" />
            <h2 className="text-3xl font-bold mb-4">Select Your Location</h2>
            <p className="text-amber-100 mb-8 max-w-2xl mx-auto">
              Get city-specific insights, local case studies, and connect with energy services businesses in your area.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-4 max-w-4xl mx-auto">
              {cities.map((city) => (
                <Link
                  key={city.slug}
                  href={`/${city.slug}/energy-services`}
                ...
                >
                  ...
                  <div className="text-sm text-amber-100 mb-4">{city.region}</div>
          ...
          {/* Key Modules Preview */}
          <div className="mt-16">
            <h2 className="text-3xl font-bold mb-8 text-center">Key Odoo Modules for Energy Services</h2>
